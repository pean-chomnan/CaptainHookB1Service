--	DROP PROCEDURE CAPTAINHOOK_PRD."USP_GetBatchByBatch"

ALTER PROCEDURE CAPTAINHOOK_PRD."USP_GetBatchByBatch"(IN WhsCode Varchar(30),IN ItemCode Nvarchar(50),IN BatchNo Varchar(100))
AS
BEGIN	
	SELECT DISTINCT
	...
	WHERE T0."ItemCode" = ItemCode AND T0."WhsCode" = WhsCode 
		AND T1."Status" <= (0)
		AND T1."DistNumber"=BatchNo;
END;
 
 CALL CAPTAINHOOK_PRD."USP_GetBatchByBatch"('03.HKT05','1IGSTIOD','BY001');
