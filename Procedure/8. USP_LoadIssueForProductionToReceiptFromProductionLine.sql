--DROP PROCEDURE CAPTAINHOOK_PRD."USP_LoadIssueForProductionToReceiptFromProductionLine";

ALTER PROCEDURE CAPTAINHOOK_PRD."USP_LoadIssueForProductionToReceiptFromProductionLine" (IN ProductionOrderEntry VARCHAR(1000)) 
AS 
	BEGIN 
		POEntry=(
...
CALL CAPTAINHOOK_PRD."USP_LoadIssueForProductionToReceiptFromProductionLine" ('10,14') ;

-- CALL CAPTAINHOOK_PRD."USP_LoadIssueForProductionToReceiptFromProductionLine"('14,15,16')
